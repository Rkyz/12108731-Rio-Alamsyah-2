    ...
    return (
        <div
            className={`w-full fixed max-h-[86.5px] z-[49] h-full bg-white py-[20px] md:pr-[10px] max-md:pr-[10px]  flex items-center justify-between border-b-[2px] border-gray-200 ${side
                ? 'pl-[260px] max-md:pl-[95px] max-sm:pl-[10px]'
                : 'pl-[100px]  max-md:pl-[10px]'}`}>
            <div className='w-auto h-full flex items-center gap-[10px] '>
                <button
                    onClick={handleSide}
                    className=' bg-[#EDEEF2] text-gray-400 z-[30] rounded-sm p-[12px] text-[20px] capitalize'>
                    <RxHamburgerMenu/>
                </button>
                <div
                    className='bg-[#EEEEF1] max-md:hidden h-full flex items-center rounded-sm gap-[10px]'>
                    ...
                    <input
                        ...
                        className='bg-transparent outline-none border-none placeholder:capitalize placeholder:font-bold'/>
            ...
            <div
                className='w-full flex gap-[10px] items-center justify-end h-full bg-transparent'>
                <button
                    className='bg-transparent bg-opacity-10 gap-[10px] h-full rounded-sm font-bold capitalize text-gray-400 flex items-center p-[10px]'>
