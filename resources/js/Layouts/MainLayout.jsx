...
const MainLayout = ({children, categorys, auth, handleOpenMenu, openMenu, dataProduct, setOpenMenu, customers}) => {
  console.log(auth)
    ...
    <div className={`w-full relative h-screen flex ${openCart | form && 'overflow-hidden hidden-scroll'}`}>
      ...
      <div className=' w-full h-full'>
        <div className='flex flex-col z-[49] w-full h-full'>
          <Top handleSide={handleSide} handleOpenCart={handleOpenCart} side={side} auth={auth}/>
